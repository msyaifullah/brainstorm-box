...
import { FlightSegment } from "../../components/ui/flight-types";
...
export default function FlightDemoPage() {
  ...
  const [multiCitySegmentsWithDates, setMultiCitySegmentsWithDates] = useState<FlightSegment[]>([
    {
      id: "1",
  ...
  const handleMultiCitySegmentsChange = (segments: FlightSegment[]) => {
  ...
  const handleMultiCitySearch = (segments: FlightSegment[]) => {
    const searchParams: SearchParams = {
      segments,
      type: "multi-city",
      passengers,
